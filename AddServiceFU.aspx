<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="AddServiceFU.aspx.cs" Inherits="AddServiceFU" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_main" Runat="Server">
 ...
 INJURIES SUSTAINED IN THIS ACCIDENT? 
    ...
    <script>
        ...
        function serviceadded(fuid,id) {
            alert("Record added successfully");
            window.history.replaceState(null, null, "?FUid=" + fuid + "&Id=" + id);
            location.reload();
        }
