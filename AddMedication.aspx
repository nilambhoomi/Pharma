<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddMedication.aspx.cs" Inherits="ePharmaTrax.AddMedication" %>
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                <textarea runat="server" id="txtMedication" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
